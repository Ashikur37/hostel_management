...
<div style="margin: 10px;">
    ...
    <div class="row">
        <div class="col-md-5">
                <nav class="navbar navbar-dark navbar-2 bg-success mb-4">
                        <a style="font-size:22px;font-weight:bold;" class="navbar-brand" href="#">Boys Hostel 1</a>
                        <!-- Navbar brand -->
                        <!-- Collapse button -->
    ...
    <div class="row">
        <div class="col-md-5">
                <nav class="navbar navbar-dark navbar-2 bg-success mb-4">
                        <a style="font-size:22px;font-weight:bold;" class="navbar-brand" href="#">Boys Hostel 2</a>
                        <!-- Navbar brand -->
                        <!-- Collapse button -->
