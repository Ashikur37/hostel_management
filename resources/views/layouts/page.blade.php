...
<body>
  <div class="row" style="margin: 10px;">
    ...
    <div class="col-sm-8">
      ...
      <center>
        <h3 style="font-size: calc(18px + (60 - 42) * (100vw - 768px) / (1440 - 768));">Online Hostel Management System for Hamdard University Bangladesh</h3>
      </center>
    </div>
    <div class="col-sm-2">
      <a style="font-size:19px;font-weight:bold;" href="/login" class="btn btn-outline-success btn-outline ">
        Login
      </a>
    </div>
  </div>
