...
<body>
  <div class="row" style="margin: 10px;">
    <div class="col-3">
      <span class=" fb fa fa-phone" style=""></span>
      <strong class="phone" style="">01643871166</strong>
    </div>
    <div class="col-7">
    ...
    <div class="col-2">
      <a style="font-size:19px;font-weight:bold;" href="/login" class="lbt btn btn-outline-success btn-outline ">
        Login
      </a>
    </div>
  </div>
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    ...
    <button data-target="#nav" data-toggle="collapse" class="navbar-toggler">
    ...
    <form class=" my-2 my-lg-0 ml-auto d-inline-block "  >
      <div class="input-group">
        <input   class="form-control mr-2 d-inline-block" type="text" placeholder="Search">
        <div class="input-group-append">
          <button class="btn btn-success my-0   my-sm-0 d-inline-block" type="button">Search</button>
        </div>
      </div>
    </form>
    </div>
