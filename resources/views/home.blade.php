        ...
        <div class="site-navbar bg-light">
          <div class="py-1">
            <div class="row align-items-center">
              <div class="col-2">
                <h2 class="mb-0 site-logo"><a href="index.html">Hostel Management System</a></h2>
              </div>
              <div class="col-10">
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      ...
                      <li><a href="events.html">Hostel Facilities</a></li>
                      <li><a href="about.html">Rules & Regulation</a></li>
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
              ...
              <h1 class="mb-2">Welcome To Hostel Management System</h1>
              <h2 class="caption">Hotel &amp; </h2>
            </div>
          </div>
        </div>
      </div>  
